(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/http'), require('lodash'), require('angular2-text-mask')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/http', 'lodash', 'angular2-text-mask'], factory) :
	(factory((global.ng4CountryPhoneSelect = global.ng4CountryPhoneSelect || {}),global.ng.core,global._angular_common,global._angular_forms,global._angular_http,global._,global.angular2TextMask));
}(this, (function (exports,_angular_core,_angular_common,_angular_forms,_angular_http,_,angular2TextMask) { 'use strict';
...
var IntPhonePrefixComponent = /** @class */ (function () {
     ...
     * @param {?} http
     */
    function IntPhonePrefixComponent(service, localeService, phoneComponent, http) {
        ...
        this.disabled = false;
        this.value = '';
        this.mask = ['+', /[1-9]/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/];
     ...
     * @return {?}
     */
    IntPhonePrefixComponent.prototype.detectCountry = function () {
        var _this = this;
        if (this.autoDetectCountry) {
            this.http.get("https://ipinfo.io").subscribe(function (res) {
                var /** @type {?} */ response = res.json();
                var /** @type {?} */ country = response.country.toLowerCase();
                _this.defaultCountry = country;
                _this.updatePhoneInput(_this.defaultCountry);
            });
        }
    };
    /**
    ...
    IntPhonePrefixComponent.propDecorators = {
        ...
        'autoDetectCountry': [{ type: _angular_core.Input },],
...
//# sourceMappingURL=ng4-country-phone-select.umd.js.map
